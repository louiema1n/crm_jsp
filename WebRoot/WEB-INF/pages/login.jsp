	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
		...
		<tr>
			...
			<td class="login_msg" width="400">
				...
				<!-- 表单 -->
				<s:form action="staffAction_login" namespace="/" method="post" >
					...
					<br/>
					用户名：<s:textfield name="loginName" cssStyle="msg"></s:textfield><br/><br/>
					密&nbsp;码：<s:password name="loginPwd" cssStyle="msg"></s:password><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<s:submit value="登录" cssStyle="btn"></s:submit>
				</s:form>
				<!-- 表单 -->
